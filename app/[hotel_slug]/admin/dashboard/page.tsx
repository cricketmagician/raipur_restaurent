...
import { useHotelBranding, useSupabaseRequests, updateSupabaseRequestStatus, HotelRequest, signOut, useAuth, useProfile } from "@/utils/store";
...
export default function AdminDashboard() {
    ...
    useEffect(() => {
        if (!loading && profile && profile.role === 'waiter') {
            router.replace(`/${hotelSlug}/admin/waiter`);
        }
    }, [loading, profile, hotelSlug, router]);
