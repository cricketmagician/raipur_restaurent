                                    ...
                                    <div className="pt-2">
                                        <AnimatePresence mode="wait">
                                            {cart[item.id] > 0 ? (
                                                ...
                                                <button 
                                                    onClick={(e) => { e.stopPropagation(); addToCart(item, e as any); }}
                                                    className="px-6 py-2.5 bg-[#0F3D2E] text-white text-[10px] font-black uppercase tracking-widest rounded-full shadow-lg hover:scale-105 active:scale-95 transition-all"
                                                >
                                                    + Add to Bag
                                                </button>
                                            )}
